      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            <button className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors cursor-pointer hover:scale-105 active:scale-95 transform transition-transform">
              Get Started
            </button>
          </div>
        </div>
